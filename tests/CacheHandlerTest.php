...
{
    return TestCacheHandler::wp_cache_set($id, $value, $group, $expires);
}

function wp_cache_get($id, $group, $default = false)
{
    return TestCacheHandler::wp_cache_get($id, $group, $default);
}

function wp_cache_delete($id, $group)
{
    return TestCacheHandler::wp_cache_delete($id, $group);
}

class TestCacheHandler extends TestCase
{
    /**
     * @var callable
     */
